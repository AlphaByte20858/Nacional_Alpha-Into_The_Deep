...
public class AutoEsquerda extends LinearOpMode {
    public void runOpMode() throws InterruptedException {
        ...
        sample1 = peixinho.actionBuilder(new Pose2d(12, 45, Math.toRadians(135)))
                ...
                .splineToLinearHeading(new Pose2d(17, 35, Math.toRadians(0)), Math.toRadians(0))
                .build();

        basket2 = peixinho.actionBuilder(new Pose2d(17, 34, Math.toRadians(0)))
                .setTangent(Math.toRadians(0))
                .splineToLinearHeading(new Pose2d(5, 42, Math.toRadians(145)), Math.toRadians(145))
                .build();

        sample2 = peixinho.actionBuilder(new Pose2d(16, 45, Math.toRadians(145)))
                .setTangent(Math.toRadians(-45))
                .splineToSplineHeading(new Pose2d(16, 44, Math.toRadians(0)), Math.toRadians(0))
                .build();
